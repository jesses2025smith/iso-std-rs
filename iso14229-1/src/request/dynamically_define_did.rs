...
use crate::{
    ...
    utils, Configuration, DefinitionType, DynamicallyDID, DynamicallyMemAddr, Iso14229Error,
    RequestData, Service,
};
    ...
    fn try_parse(request: &Request, _: &Configuration) -> Result<Self, Iso14229Error> {
        ...
        match sub_func {
            ...
            DefinitionType::DefineByMemoryAddress => {
                ...
                let mem_addr =
                    utils::slice_to_u128(&data[offset..offset + mem_addr_len], ByteOrder::Big);
                offset += mem_addr_len;
                let mem_size =
                    utils::slice_to_u128(&data[offset..offset + mem_size_len], ByteOrder::Big);
                offset += mem_size_len;
